      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-purple-100 dark:border-gray-700 transition-all duration-500">
            {/* Poster Space */}
            <div className={`h-80 bg-gradient-to-br ${currentTrip.gradient} flex items-center justify-center relative overflow-hidden`}>
              <div className="absolute inset-0 bg-black/20"></div>
              <div className="text-white text-center z-10">
                <div className="text-6xl mb-4">🏔️</div>
                <p className="text-xl font-semibold mb-2">Poster Space</p>
                <p className="text-sm opacity-90">Beautiful {currentTrip.title} image will be added here</p>
              </div>
            </div>
            ...
            <div className="p-8">
              ...
              <div className="flex justify-between items-center mb-6">
                <span className="text-gray-500 dark:text-gray-400 font-medium">Duration: {currentTrip.duration}</span>
              ...
              <Button className="w-full bg-gradient-to-r from-purple-600 to-lavender-600 hover:from-purple-700 hover:to-lavender-700 text-white font-semibold py-3 px-6 rounded-xl text-lg transition-all duration-300 transform hover:scale-105">
                Add to Cart
              </Button>
            </div>
          </div>
