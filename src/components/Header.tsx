        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button className="p-2 rounded-full hover:bg-purple-50 dark:hover:bg-gray-700 transition-colors duration-200">
            ...
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 bg-white dark:bg-gray-900 border-t border-purple-100 dark:border-gray-700">
                ...
                <div className="flex items-center space-x-4 px-3 py-2">
                  ...
                  <button className="p-2 rounded-full hover:bg-purple-50 dark:hover:bg-gray-700">
                    <User className="h-6 w-6 text-gray-700 dark:text-gray-300" />
                  </button>
